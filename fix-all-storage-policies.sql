-- Fix storage policies for ALL buckets using standard PostgreSQL policy syntax
...
-- 3. Create policies for product-documents bucket
...
-- 4. Verify all the policies were created
